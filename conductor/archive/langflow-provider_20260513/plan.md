...
- [x] Task 1: Update `ProviderPreset` type and `ProviderConfig` interface
...
- [x] Task 2: Update `validateProviderConfig()` for Langflow
...
- [x] Task 3: Update `getProviderReadiness()` for Langflow
...
- [x] Task 4: Write unit tests for config changes
...
- [x] Task 1: Create `LangflowService` class
...
- [x] Task 2: Write unit tests for `LangflowService`
...
- [x] Task 1: Update `initService()` factory in `background.ts`
...
- [x] Task 2: Update `providerTester.ts` for Langflow
...
- [x] Task 3: Update background/providerTester tests
...
- [x] Task 1: Update `ProviderSection.tsx` for Langflow preset
...
- [x] Task 2: Update onboarding wizard for Langflow preset
...
- [x] Task 3: Run full test suite and fix any regressions

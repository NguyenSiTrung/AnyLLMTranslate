...
- [x] Task 4: Conductor - User Manual Verification 'Implementation' (Protocol in workflow.md)

## Phase 2: Validation
<!-- execution: sequential -->
<!-- depends: phase1 -->

- [x] Task 1: Insert mock VTT sprite payload logic in `tests/unit/udemyHandler.test.ts`.
- [x] Task 2: Add test asserting that `udemyHandler` returns an empty array `[]` when processing the mocked payload.

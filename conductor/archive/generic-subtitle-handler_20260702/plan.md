...
- [x] Task 1: Write unit tests for GenericSubtitleHandler URL pattern matching
...
- [x] Task 2: Implement GenericSubtitleHandler class
...
- [x] Task 3: Implement content validation
...
- [x] Task 4: Implement getNativeCaptionHide() with common selectors
...
- [x] Task 5: Write unit tests for content validation and native caption hide
...
- [x] Task 1: Write tests for Content-Type matching in InterceptorRegistry
...
- [x] Task 2: Extend InterceptorRegistry with Content-Type matching
...
- [x] Task 3: Wire Content-Type detection into XhrInterceptor
...
- [x] Task 4: Wire Content-Type detection into FetchInterceptor
  - After response is received, if URL pattern didn't match, check Content-Type header
  - If Content-Type matches subtitle patterns, intercept and translate
  <!-- files: inject/fetchInterceptor.ts -->

- [x] Task 5: Add Content-Type patterns to GenericSubtitleHandler
...
- [x] Task 1: Write tests for generic DOM cue source selectors
...
- [x] Task 2: Implement getDomCueSource() on GenericSubtitleHandler
...
- [x] Task 3: Wire generic DOM cue source into coordinator
...
- [x] Task 1: Write tests for handler priority (specific > generic)
...
- [x] Task 2: Register GenericSubtitleHandler in content.ts
...
- [x] Task 3: Register GenericSubtitleHandler in inject.content/index.ts
  - Import GenericSubtitleHandler
  - Register LAST in the registerSubtitleHandlers() array
  <!-- files: entrypoints/inject.content/index.ts -->

- [x] Task 4: Verify detect() priority logic
...
- [x] Task 1: Add enableGenericSubtitleHandler to SubtitleSettings type
...
- [x] Task 2: Write tests for settings toggle behavior
...
- [x] Task 3: Wire settings to handler registration
...
- [x] Task 4: Add toggle UI in Options -> Subtitles section
...
- [x] Task 5: Update SUPPORTED_SUBTITLE_SITES in lib/subtitleSites.ts
...
- [x] Task 6: Update Settings UI tests
...
- [x] Task 1: Run full test suite (pnpm test)
  - Verify all existing tests pass
  - Verify new tests pass
  - Fix any regressions

- [x] Task 2: Run lint (pnpm lint)
  - Fix any new lint errors

- [x] Task 3: Run typecheck (tsc --noEmit)
  - Fix any type errors

- [x] Task 4: Run build (wxt build)
  - Verify build succeeds
  - Check bundle size impact

- [x] Task 5: Capture learnings

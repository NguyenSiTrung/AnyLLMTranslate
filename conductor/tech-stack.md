...
- Docs added: `docs/hbomax-subtitle-risk-audit.md` (42 findings, per-finding status table, §7 live-verification backlog) and `docs/superpowers/plans/2026-09-11-hbomax-subtitle-fixes.md` (936-line eight-phase plan).

...
- [x] Task 1: Patch XHR to block readyState 4 delivery until translated
...
- [x] Task 2: Patch XMLHttpRequest.prototype.addEventListener for load/readystatechange
...
- [x] Task 3: Write unit tests for XHR block-and-wait behavior
...
- [x] Task 1: Add clearPendingRequest to coordinator
...
- [x] Task 2: Wire SUBTITLE_TRANSLATED success path into coordinator
...
- [x] Task 3: Write unit tests for coordinator timeout-clearing
...
- [x] Task 1: Add origin validation to postMessage bridge
...
- [x] Task 2: Add HTTP error guard to fetch interceptor
...
- [x] Task 1: Precise video targeting in subtitleOverlay
...
- [x] Task 2: Fix YouTube JSON3 segment join

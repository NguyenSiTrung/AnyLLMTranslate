...
- [ ] Task 1.1: Write failing tests for lib/rateLimiter.ts (RED)
...
- [ ] Task 1.2: Implement lib/rateLimiter.ts (GREEN)
...
- [ ] Task 1.3: Conductor - Phase Verification 'Pure RPM Rate Limiter Module' (Protocol in workflow.md)

## Phase 2: Settings Plumbing

- [ ] Task 2.1: Add maxRpm to types/config.ts
...
- [ ] Task 2.2: Add maxRpm to extractSettings() in settingsStore.ts
  - Without this, the field never surfaces through `useSettings()`

- [ ] Task 2.3: Add settings plumbing tests
...
- [ ] Task 2.4: Conductor - Phase Verification 'Settings Plumbing' (Protocol in workflow.md)

## Phase 3: Service Integration

- [ ] Task 3.1: Thread maxRpm into OpenAICompatibleService
...
- [ ] Task 3.4: Conductor - Phase Verification 'Service Integration' (Protocol in workflow.md)

## Phase 4: Options UI — Rate Limiting Card

- [ ] Task 4.1: Add maxRpm to export/import object in AdvancedSection
  - Add `maxRpm: settings.maxRpm` alongside `maxBatchChars`/cache fields

- [ ] Task 4.2: Add "Rate Limiting" Card with validated input
...
- [ ] Task 4.3: Extend AdvancedSection tests
...
- [ ] Task 4.4: Conductor - Phase Verification 'Options UI' (Protocol in workflow.md)
...
- [ ] Task 5.2: Manual verification + capture learnings

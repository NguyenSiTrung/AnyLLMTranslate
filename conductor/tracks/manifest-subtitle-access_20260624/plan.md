...
- [ ] Task 1: TextTrack cue extraction helper
...
- [ ] Task 2: Wire full-track emission into textTrackDiscovery
...
- [ ] Task 3: Coordinator TextTrack→translate flow
...
- [ ] Task: Conductor - User Manual Verification 'HTML5 TextTrack Cue Reading' (Protocol in workflow.md)
...
- [ ] Task 1: MSE cue payload type + bridge message
...
- [ ] Task 3: Coordinator MSE→translate flow
...
- [ ] Task: Conductor - User Manual Verification 'MSE SourceBuffer Interceptor' (Protocol in workflow.md)
...
- [ ] Task 1: Coordinator source precedence state
...
- [ ] Task 2: Full suite + lint + build verification
...
- [ ] Task: Conductor - User Manual Verification 'Source Precedence Integration' (Protocol in workflow.md)

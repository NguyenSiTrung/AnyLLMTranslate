...
describe('statsQuery', () => {
  ...
  describe('period windows', () => {
    it('lists finite period dates and previous non-overlapping windows', () => {
  ...
  describe('aggregation helpers', () => {
    it('sums counters, lifetime vs period, percent deltas, and top entries', () => {
      const days = [
  ...
  describe('buildInsights', () => {
    it('returns up to 3 insights and mentions cache when activity exists', () => {
  ...
  describe('loadDaysForPeriod', () => {
    it('loads existing records for finite periods and all records for all', async () => {

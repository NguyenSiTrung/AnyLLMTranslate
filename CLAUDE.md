...
## Git Policy (overrides the managed Beads block above)
...
same per task. The managed Beads block states it does not override repository,
...
- Everything else in the managed Beads block stands unchanged.

...
describe('YouTubeHandler', () => {
  ...
  describe('detect / isWatchPage', () => {
    it('detects youtube hostnames and rejects others', () => {
    ...
    it('isWatchPage is true only for /watch paths', () => {
  ...
  describe('getPatterns', () => {
    it('matches timedtext URLs and extracts lang/tlang (tlang wins)', () => {
  ...
  describe('getMetadataPatterns', () => {
    it('matches youtubei player API', () => {
  ...
  describe('extractAvailableTracks', () => {
    ...
    it('parses captionTracks including ASR and filters empty language codes', () => {
    ...
    it('returns empty for invalid/missing tracks and falls back label to languageCode', () => {
      ...
      const tracks = handler.extractAvailableTracks(
        JSON.stringify({
          captions: {
            playerCaptionsTracklistRenderer: {
...
<transcript>
  ...
  <text start="4.0" dur="3.0">Second cue</text>
    ...
    it('parses srv3 XML and skips empty text elements', () => {
...
<transcript>
  ...
  <text start="1.0" dur="2.0">Valid cue</text>
    ...
    it('parses json3 (fmt param / content-type / fallback) and filters empty events', () => {
    ...
    it('returns empty for unparseable/empty content', () => {

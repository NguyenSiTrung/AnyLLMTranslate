...
- **Text selection translate** — select any text, click the floating translate button; results appear in a tooltip with copy & close actions. Short selections use **dictionary mode** (phonetic, part of speech, definitions, examples, contextual analysis) when enabled; longer sentences stay translation-only

...
describe('reorderByIndex', () => {
  it('moves forward/backward, no-ops out of range, and does not mutate input', () => {
...
describe('moveProviderById', () => {
  ...
  it('moves up/down and no-ops at list edges', () => {
...
describe('moveKeyById', () => {
  ...
  it('reorders keys without mutating the original array', () => {
